...
echo "- Start deploying image version "$1
...
kubectl set image deployments/liquidator-deployment liquidator-poller=082576982398.dkr.ecr.ca-central-1.amazonaws.com/liquidator-poller:$1